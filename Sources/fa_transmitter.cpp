...
FaTransmitter::FaTransmitter(int port, QObject *parent):
                             QObject(parent)
{
//    // init
...
//    FaApacheSe *connection = new FaApacheSe();
//    connect(connection, SIGNAL(dataReady(QString, int)),
//            this, SLOT(readyRead(QString, int)));
//    connect(connection, SIGNAL(disconnected(int)),
//            this, SLOT(handleDisconnect(int)));
//    connect(connection, SIGNAL(connected(int)),
...
//    {
//        int id = 0;
//        fa_cons[i]->write(id, QString(data_b));
//    }
